...
def face_swap(src_face, dst_face, src_points, dst_points, dst_shape, dst_img, args, start = 0, end=48):
    h, w = dst_face.shape[:2]

    ## 3d warp
    warped_src_face = warp_image_3d(src_face, src_points[start:end], dst_points[start:end], (h, w))
    ## Mask for blending
    ...
    ## 2d warp
    if args.warp_2d:
        unwarped_src_face = warp_image_3d(warped_src_face, dst_points[start:end], src_points[start:end], src_face.shape[:2])
