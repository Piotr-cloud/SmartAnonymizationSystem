...
from NonPythonFiles.WorkersFiles.Detectors.LPD_YuNet import LPD_YuNet_defaultModel_path




class LPD_YuNet_Cls(LicensePlatesDetector_AbstCls):
    ...
    @staticmethod
    def getDescription():
        return "Deep neural network detector. LPD_YuNet: License plate detector trained with Chinese license plates, so the detection results of other license plates with default model may be limited"
    ...
    def __init__(self, 
            modelPath = UserCfg_Path(
                ...
                path = LPD_YuNet_defaultModel_path),
    ...
    def _detect(self, nparray):
        ...
        try:
            results = self._model.detect(nparray)[1] # there is an issue in some cases
            
        except:
            results = [] #np.array([0,0,w,h])]
    ...
    def getLicense():
        return License_Cls(
            ...
            srcCodeLocation = "https://github.com/opencv/opencv_zoo/tree/master/models/license_plate_detection_yunet",
